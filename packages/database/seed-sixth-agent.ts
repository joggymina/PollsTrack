...
async function main() {
  console.log("Seeding sixth Agent + Polling Station...\n")
  ...
  console.log("\n========================================")
  console.log("SIXTH AGENT READY")
  console.log("========================================")
  console.log(`Phone to login     : 254700000006`)
